...
If the session metadata database or schema is not yet available, the preview keeps the requested destination and reports why it is unavailable without blocking job creation or listing.
